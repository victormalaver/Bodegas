...
(function() {
    var provider = app.data.bodegas = new Everlive({
            offlineStorage: true,
            appId: 'dfscuxt1dmnqv4r6',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'bodegas_access_token',
...
// START_CUSTOM_CODE_bodegas
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_bodegas